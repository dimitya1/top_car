<div class="items-center -mx-2 md:flex">
    <div class="w-full mx-2">
        <label class="block mb-2 text-sm font-medium text-white">@lang('app.car_brand.name')</label>
    ...
    <div class="w-full mx-2 mt-4 md:mt-0">
        <label class="block mb-2 text-sm font-medium text-white">@lang('app.car_model.name')</label>
