    ...
    'layout'        => [
        ...
        'header' => [
            ...
            'menu_list'      => [
                'about_us'       => 'Про нас',
                'reviews'        => 'Отзывы',
                'contacts'       => 'Контакты/Сотрудничество',
                ...
                'admin'          => [
                    ...
                    'feedback'      => 'Фидбэк',
                    'activity_logs' => 'Логирование БД',
                ],
            ],
        ],
    ],
    'home'          => [
        'best_reviews_service' => ' - лучший сервис отзывов про автомобили',
        'reviews_service'      => 'TopCar - сервис отзывов про автомобили',
        'we_offer'             => 'Мы предлагаем нашим пользователям:',
        'portfolio'            => 'портфолио различных автомобилей',
        'hundreds_of_reviews'  => 'сотни отзывы на разные модели',
        'ability_to_filter'    => 'возможность отфильтровать по конкретному автомобилю',
        'view_recommended'     => 'просмотреть рекомендованные марки и модели',
        'create_account'       => 'создать свою учётную запись',
        'integrate_api'        => 'пользоваться интеграцией с нашим сервисом',
    ],
    'authorization' => [
        'login'                   => 'Логін',
        'log_in'                  => 'Увійти',
